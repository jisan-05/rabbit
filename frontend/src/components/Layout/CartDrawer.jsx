...
const CartDrawer = ({ drawerOpen, toggleCartDrawer }) => {
    return (
        <div
            className={`fixed top-0 right-0 w-3/4 sm:w-1/2 md:w-[32rem] h-full bg-white shadow-lg transform transition-transform duration-300 flex flex-col z-50 ${
        ...
        >
            ...
            <div className="p-4 bg-white sticky bottom-0">
                ...
                <p className="text-sm tracking-tighter text-gray-500 mt-2 text-center">
                    Shipping, taxes, and discount codes calculate to checkout
                </p>
            </div>
        </div>
    );
